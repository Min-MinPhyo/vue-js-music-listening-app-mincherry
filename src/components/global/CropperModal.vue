<template>
    ...
    <div class="relative z-10 ">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto mt-6">
            ...
            <div class="flex min-h-full items-end justify-center p-4 items-center">
                        ...
                        <div class="flex items-center">
                            <div class="mt-3 text-left">
                                ...
                                <div class="flex justify-center max-w-2xl">
                                    <Cropper ref="cropper" :src="uploadedImage" alt="image" :stencil-props="{
                                        minAspectRatio: minAspectRatioProp.width / minAspectRatioProp.height,
                                        maxAspectRatio: maxAspectRatioProp.width / minAspectRatioProp.height
                                    }" @change="change" />
                                </div>
...
const crop = () => {
    ...
    croppedImageData.width = coordinates.height;
