...
<template>
    <div id="centerCallToAction" class="max-w-5xl">
        <div class="px-4 md:w-3/4 lg:w-2/3 mx-auto text-center">
            ...
            <p class="pt-2 text-xl text-center text-gray-300">
                Login or Register now and join other like minded people all around the world who want to share there
                music!
            </p>
    ...
    <div id="videoDarkOverlay">
        <video autoplay muted loop id="myVideo">

            <source src="../../../public/img/Concert.mp4" type="video/mp4">
