<template>
    <div>
        ...
        <div v-show="open"
            ...
            <div class="my-video fixed border-white w-80 pt-16">
                <p class="text-2xl text-center text-white font-bold">
                    Menu
                </p>

                <RouterLinkButton @click="open = !open" class="w-full text-gray-100 text-center text-lg"
                    btnText="Profile" color="green" url="/account/profile" />



                <RouterLinkButton @click="open = !open" class="w-full text-gray-100 text-center text-lg" btnText="Posts"
                    color="green" url="/account/posts" />
